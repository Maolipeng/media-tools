...
export default function Home() {
  ...
  const promptTemplates = [
    ...
    {
      title: "霓虹弹跳字幕",
      text: "给视频添加字幕“哈哈哈哈哈”，霓虹发光效果（用 drawtext + gblur/boxblur 实现，避免使用 glow 滤镜），弹跳入场，停留 2 秒后淡出。"
    },
    {
      title: "描边弹跳",
      text: "给视频添加字幕“出发！”，粗描边+轻微阴影，弹跳入场后稳定停留 2 秒，再淡出。"
    },
    {
      title: "打字机字幕",
      text: "给视频添加中文字幕“今天也要加油”，打字机逐字出现（每字 0.1 秒），完成后停留 2 秒淡出。"
    },
    {
      title: "粒子散开",
